...
const Personal = () => {
  return (
    <section id="profile" className="flex flex-row py-10 gap-x-16 text-white w-screen px-8 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-14">
      <div className="flex flex-col basis-1/2 gap-y-16">
        ...
        <p className="text-gray-300 font-roboto_mono text-sm sm:text-xs lg:text-xl">
          My name is Naufal Nafidiin, a passionate individual at the intersection of art and technology, combining creativity and technical expertise to craft compelling experiences. Skilled in game development, 3D modeling, narrative writing, and web development, I thrive on blending artistic expression with technological innovation to bring unique ideas to life.
        </p>
