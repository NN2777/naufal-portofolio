  ...
  return (
    <div className="absolute flex flex-row w-screen top-0 px-10 sm:px-20 py-6 sm:py-10 items-center text-white z-10">
      ...
      <div className="absolute">
        <span className="text-xl sm:text-3xl font-segoe_ui_bold cursor-pointer" onClick={() => scrollToSection("home")}>Norcana._</span>
      </div>
      ...
      <div className="hidden sm:flex flex-row gap-4 sm:gap-8 justify-center mx-auto font-roboto_mono">
        <div className="column-2">
          ...
          <div className="text-base sm:text-lg font-medium cursor-pointer" onClick={() => scrollToSection("home")}>// home</div>
        </div>
        <div className="column-2">
          <div className="text-right text-sm sm:text-base font-regular">02</div>
          <div className="text-base sm:text-lg font-medium cursor-pointer" onClick={() => scrollToSection("profile")}>// profile</div>
        </div>
        <div className="column-2">
          <div className="text-right text-sm sm:text-base font-regular">03</div>
          <div className="text-base sm:text-lg font-medium cursor-pointer" onClick={() => scrollToSection("work")}>// work</div>
        </div>
        <div className="column-2">
          <div className="text-right text-sm sm:text-base font-regular">04</div>
          <div className="text-base sm:text-lg font-medium cursor-pointer" onClick={() => scrollToSection("experience")}>// experience</div>
        </div>
        <div className="column-2">
          <div className="text-right text-sm sm:text-base font-regular">05</div>
          <div className="text-base sm:text-lg font-medium cursor-pointer" onClick={() => scrollToSection("contact")}>// contact</div>
        </div>
      </div>
